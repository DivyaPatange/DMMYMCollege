...
<aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      <div class="mdc-drawer__header">
        <a href="index.html" class="brand-logo">
          <img src="{{ asset('brandAssets/images/logo/dmmmLogo.jpg') }}" style="width: 192px;height: 109px;" alt="logo">
          {{-- <h3>Vimladevi Ayurvedic Medical College</h3> --}}
        </a>
      </div>
            ...
            <div class="mdc-list-item mdc-drawer-item">
              ...
              <div class="mdc-expansion-panel" id="ui-sub-menu">
                <nav class="mdc-list mdc-drawer-submenu">
                  ...
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="{{ route('internship.list') }}">
                      Internship List
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="{{ route('internship.add') }}">
                      Add Internship
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="{{ route('index.internship.completion') }}">
